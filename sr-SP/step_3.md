...
+ Your timer should start when button A is pressed. Add a new `on button A pressed` block to your script:
    ...
    ![слика екрана](images/clock-a-pressed.png)
...
+ Click 'run' to test your code.
    ...
    ![слика екрана](images/clock-test.png)
